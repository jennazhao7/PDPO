...
SCRIPT="${ROOT_DIR}/stage2_debugging/stage1/run_stage1_pku_base_longepoch_1gpu.sh"
...
JOB_NAME="s1_pku_base_longepoch_eps${EPS}_s${SEED}"
QSUB_OUT="${OUT_ROOT}/qsub_${JOB_NAME}.out"
QSUB_ERR="${OUT_ROOT}/qsub_${JOB_NAME}.err"

echo "[INFO] Submitting PKU Base Longer Epoch Stage 1 job (1 GPU)..."
