...
STAGE2_DIR="${OUT_ROOT}/stage2_mle/${MODEL//\//--}_stage2_mle_eps1.0_seed${SEED}"
...
LOG_TXT="${OUT_ROOT}/logs/eval_mle_${MODEL//\//--}_seed${SEED}.txt"
...
echo "[$(date)] Running Preference Accuracy Evaluation (MLE)" >> "$LOG_TXT"
