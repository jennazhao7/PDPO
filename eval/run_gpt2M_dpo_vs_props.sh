#!/bin/bash
# Script to run evaluation: Jennazhao7/gpt2-medium-dpo-m1-v2 vs PROPS checkpoint
# Usage: bash eval/run_gpt2M_dpo_vs_props.sh
...
BASELINE_MODEL="Setpember/Jon_GPT2M_DPO_props_epi_point5"  # PROPS checkpoint (epsilon=0.5)
OUTPUT_CSV="eval/gpt2M-dpo-m1-v2_vs_props-ep05.csv"
NUM_PROMPTS=100
...
echo "Baseline PROPS (B): $BASELINE_MODEL"
