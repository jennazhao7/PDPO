#!/bin/bash
# Script to run evaluation: Jennazhao7/gpt2-medium-dpo-m1-v2 vs DP-SGD PROPS checkpoint
# Usage: bash eval/run_gpt2M_dpo_vs_dpsgd.sh
...
# === Configuration ===
YOUR_MODEL="Jennazhao7/gpt2-medium-dpo-m1-v2"  # Your DPO model
BASELINE_MODEL="Setpember/Jon_GPT2M_DPSGD_epi_point1"  # DP-SGD PROPS checkpoint (epsilon=0.1)
OUTPUT_CSV="eval/gpt2M-dpo-m1-v2_vs_dpsgd-ep01.csv"
NUM_PROMPTS=100
...
echo "Baseline DP-SGD (B): $BASELINE_MODEL"
